...
export const INITIAL_SERVERS: any[] = [
  { id: '1', name: 'Production Web 01', host: '192.168.1.105', username: 'admin', port: 22, status: 'online', lastConnected: '2 mins ago' },
  { id: '2', name: 'Database Primary', host: 'db-prod.internal', username: 'postgres', port: 2222, status: 'offline', lastConnected: '1 day ago' },
  { id: '3', name: 'Staging Environment', host: '10.0.0.45', username: 'ubuntu', port: 22, status: 'online', lastConnected: 'Now' },
];

export const MOCK_FILES: any[] = [
  { id: 'f1', name: 'var', type: 'directory', size: 0, modified: '2023-10-24 14:20', permissions: 'drwxr-xr-x', owner: 'root' },
  { id: 'f2', name: 'etc', type: 'directory', size: 0, modified: '2023-11-12 09:15', permissions: 'drwxr-xr-x', owner: 'root' },
  { id: 'f3', name: 'home', type: 'directory', size: 0, modified: '2023-08-05 11:44', permissions: 'drwxr-xr-x', owner: 'root' },
  { id: 'f4', name: 'config.yaml', type: 'file', size: 2048, modified: '2023-12-01 18:30', permissions: '-rw-r--r--', owner: 'ubuntu' },
  { id: 'f5', name: 'main.py', type: 'file', size: 12450, modified: '2023-12-05 10:12', permissions: '-rwxr-xr-x', owner: 'ubuntu' },
  { id: 'f6', name: 'data.json', type: 'file', size: 1048576, modified: '2023-12-07 15:45', permissions: '-rw-r--r--', owner: 'ubuntu' },
  { id: 'f7', name: 'logs', type: 'directory', size: 0, modified: '2023-12-08 22:10', permissions: 'drwxr-xr-x', owner: 'ubuntu' },
];
